...
class TestParseWrittenAnswerKeyPdf(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.writing_key = REPO_ROOT / "Reference Materials" / "Writing example answer key.pdf"
...
class TestMainWindowWrittenAnnotations(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.key_path = REPO_ROOT / "Reference Materials" / "Writing example answer key.pdf"
        cls.sub_path = REPO_ROOT / "Reference Materials" / "William_john.pdf"
